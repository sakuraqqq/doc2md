...
> 发布：**v0.1.7 发布准备完成（2026-09-15；push / tag / Release 待用户在终端执行）** —— 本版**合并 v0.1.5 + v0.1.6 + v0.1.7 三批**（版本号 0.1.4 → **0.1.7**，跳过从未单独发版的 0.1.5/0.1.6）；产物 `index.html` **120,988 B / SHA `2EE82D47…1CBB`**（**字节数不变而哈希变** —— 页脚 `v0.1.4`→`v0.1.7` 等长，正是「尺寸相同不能当不变量」的实例）；契约 **246/244/0/2** · lint 0 · metrics 17/**361**/超限 0 · PWA 48/48 · OCR PASS(93%)；**独立验收（Linux 侧）六项全绿**（负对照 0% → 101% 因果锁定）+ **用户级验收通过**（4 张真机照片全可读）；**隐私 & 版权审查：通过**（落盘于 `docs/RELEASE.md` v0.1.7 节）· 观察期 2026-09-15 起 → 复盘 **≥2026-09-18** · 上一版 **v0.1.4 已发布**（tag `cfb20b76374fba384aa37e7c3edc0f9f92a31187`，2026-09-14；观察期未走完即被本版取代，如实登记）· 更早 **v0.1.3 已转正**（tag `d6929e6`，2026-09-12）· 详见 `docs/RELEASE.md` v0.1.7 节
