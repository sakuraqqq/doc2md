...
> 基线：**HEAD `f54d7a6`**（main；S4 编码判定口径 A′ + S5 `w:dstrike` 单正则交替加固 + metrics 口径 / 文档漂移 / gitignore 批） · 契约：**179/179**（**2026-09-11/12 S4/S5 批 + 收口批两相实测**：先红 168/6 → 后绿 174/174（46.6s）→ 收口批先红 21/5 → **后绿 179/179（46.0s）** 零回归；减脂批前为用户终端权威跑 153/153） · 门禁全绿（lint 0/0 · metrics 超限 0 / 重复率 0.6% · PWA 48/48 · OCR 93% PASS · 产物 diff 0） · 工作区：与版本库同目录
