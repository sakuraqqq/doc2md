...
- **发布状态（2026-09-14 实测回读）**：提交 A–F 全部推送（`dd960b1`→`fc6cfa8`→`4344293`→`d82611a`→`1e2377d`→`cfb20b7`）；**tag `v0.1.4` = `cfb20b76374fba384aa37e7c3edc0f9f92a31187`**（指向提交 F，lightweight tag）；GitHub Release 已发布；`origin/main` = `cfb20b7`、待推送 0、工作树 clean；**观察期 2026-09-14 起 → 复盘 ≥2026-09-17**。本版版本号落点已核验一致：`package.json` / `package-lock.json`(×2) / `src/template.html` footer / 产物 footer 全为 `0.1.4`。
