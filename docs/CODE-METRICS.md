...
> 生成命令：`npm run metrics`（node tools/metrics.mjs）；生成时间：2026-09-17T11:32:14.097Z
...
| src/convert.js | runConverter | 159 | 7 | 6 |
...
| src/convert.js | unsupportedError | 137 | 6 | 5 |
...
| src/convert.js | withTruncationNotice | 152 | 4 | 3 |
...
| src/convert.js | (anonymous) | 153 | 2 | 1 |
