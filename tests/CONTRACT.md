...
**两相实测（本机 · 卡 011）**：**先红** `tests 3 / pass 0 / fail 3`（exit 1）→ **后绿** 全量 **305 / 303 / 0 / 2**（带夹具）/ **302 / 299 / 0 / 3**（干净检出，CI 侧待对账）。
