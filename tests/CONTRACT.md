...
**两相实测（本机 · 卡 011）**：**第一轮** 先红 `tests 3 / pass 0 / fail 3` → 后绿全量 **305 / 303 / 0 / 2**（带夹具）/ **302 / 299 / 0 / 3**（干净检出，已由真 CI run 对账）；**第二轮（A8/A9）** 先红 `tests 5 / pass 3 / fail 2`（红在 **Z3-3**，Z3-4 免费绿）→ 后绿全量 **307 / 305 / 0 / 2**（带夹具）/ **304 / 301 / 0 / 3**（干净检出，待对账）。
